...
constexpr uint8_t DEFAULT_BRIGHTNESS = 0;
constexpr uint16_t DEFAULT_SCROLL_SPEED_MS = 75;

constexpr float MAX_FLIGHT_RADIUS_NM = 250.0f;
constexpr uint16_t MIN_SCROLL_SPEED_MS = 1;
constexpr uint16_t MAX_SCROLL_SPEED_MS = 10000;
...
struct FlightWatchSettings {
  ...
  uint16_t scrollSpeedMs = DEFAULT_SCROLL_SPEED_MS;
};
