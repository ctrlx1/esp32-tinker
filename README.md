...
- `flight_info`: HUB75 nearby-aircraft info cards from adsb.lol;
...
`flight_tracker`, `flight_info`, and `starter-hub75`.
...
four-module FC16 diagram; `flight_tracker`, `flight_info`, and `starter-hub75`
use a 64×32 HUB75 diagram.
